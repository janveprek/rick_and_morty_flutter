...
class RickAndMortyTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      primaryFixed: Color(0xffd6eb9b),
      onPrimaryFixed: Color(0xff161f00),
      primaryFixedDim: Color(0xffbbcf82),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondaryFixedDim: Color(0xff585f44),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff546524),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff394809),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.dark,
      primary: Color(0xffbfd386),
      surfaceTint: Color(0xffbbcf82),
      onPrimary: Color(0xff111900),
      primaryContainer: Color(0xff859851),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xffc7cead),
      ...
      inversePrimary: Color(0xff3e4e0f),
      primaryFixed: Color(0xffd6eb9b),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.dark,
      primary: Color(0xfff7ffd7),
      surfaceTint: Color(0xffbbcf82),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xffbfd386),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xfff8fedb),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xffc7cead),
      onSecondaryContainer: Color(0xff000000),
      ...
      primaryFixed: Color(0xffdbf09f),
      onPrimaryFixed: Color(0xff000000),
      primaryFixedDim: Color(0xffbfd386),
      onPrimaryFixedVariant: Color(0xff111900),
      secondaryFixed: Color(0xffe4eac8),
      onSecondaryFixed: Color(0xff000000),
      secondaryFixedDim: Color(0xffc7cead),
